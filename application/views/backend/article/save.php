    ...
    <div class="col-md-8">
        ...
        <form action="<?php echo B_URL; ?>article/save" method="post">
            <div class="form-group<?php if (form_error('title')) : ?> has-error<?php endif; ?>">
                ...
                <input type="text" name="title" id="input_title" class="form-control" aria-describedby="helpBlock" value="<?php echo cc_get_value(set_value('title'), $row['title']); ?>">
                <span id="helpBlock" class="help-block"><?php echo form_error('title'); ?></span>
            </div>
            
            <div class="form-group<?php if (form_error('author')) : ?> has-error<?php endif; ?>">
                <label for="input_author" class="control-label">作者</label>
                <input type="text" name="author" id="input_author" class="form-control" aria-describedby="helpBlock" value="<?php echo cc_get_value(set_value('author'), $row['author']); ?>">
                <span id="helpBlock" class="help-block"><?php echo form_error('author'); ?></span>
            </div>
            
            <div class="form-group<?php if (form_error('source')) : ?> has-error<?php endif; ?>">
                <label for="input_source" class="control-label">来源</label>
                <input type="text" name="source" id="input_author" class="form-control" aria-describedby="helpBlock" value="<?php echo cc_get_value(set_value('source'), $row['source']); ?>">
                <span id="helpBlock" class="help-block"><?php echo form_error('source'); ?></span>
            </div>
            ...
            <div class="form-group<?php if (form_error('cover_pic')) : ?> has-error<?php endif; ?>">
                ...
                <input type="text" name="cover_pic" id="input_cover_pic" class="form-control" aria-describedby="helpBlock" value="<?php echo cc_get_value(set_value('cover_pic'), $row['cover_pic']); ?>">
                <span id="helpBlock" class="help-block"><?php echo form_error('cover_pic'); ?></span>
            </div>
            ...
            <div class="form-group<?php if (form_error('top')) : ?> has-error<?php endif; ?>">
                ...
                <span id="helpBlock" class="help-block"><?php echo form_error('top'); ?></span>
            </div>
            ...
            <div class="form-group<?php if (form_error('article_category_id')) : ?> has-error<?php endif; ?>">
                ...
                <span id="helpBlock" class="help-block"><?php echo form_error('article_category_id'); ?></span>
            </div>
            
            <div class="form-group<?php if (form_error('content')) : ?> has-error<?php endif; ?>">
                <label for="editor_id" class="control-label">内容</label>
                <textarea id="editor_id" name="content"><?php echo cc_get_value(set_value('content'), $row['content']); ?></textarea>
                <span id="helpBlock" class="help-block"><?php echo form_error('content'); ?></span>
            </div>
            ...
            <div class="form-group<?php if (form_error('post_time')) : ?> has-error<?php endif; ?>">
                ...
                <input type="text" name="post_time" id="input_post_time" class="form-control" aria-describedby="helpBlock" placeholder="格式:2015-01-01 08:10:01" value="<?php echo cc_get_value(set_value('post_time'), $row['post_time']); ?>">
                <span id="helpBlock" class="help-block"><?php echo form_error('post_time'); ?></span>
            </div>
