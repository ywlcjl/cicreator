    ...
    <div class="col-md-8">
        ...
        <form action="<?php echo B_URL; ?>/create/index" method="post">
            <div class="form-group<?php if (form_error('table')) : ?> has-error<?php endif; ?>">
                ...
                <input type="text" name="table" id="input_table" class="form-control" aria-describedby="helpBlock" value="<?php echo $this->backend_lib->getValue(set_value('table')); ?>">
                <span id="helpBlock" class="help-block"></span>
                <?php echo $this->backend_lib->formError('table'); ?>
            </div>
